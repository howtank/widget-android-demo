...
class MainActivity : AppCompatActivity() {
    ...
    private fun initButtons() {
        showDefaultPositionButton.setOnClickListener {
            ...
            HowtankWidget.getInstance()
                .browse(this, true, "Page with default position", "http://c1.howtank.com/default")
        }
        ...
        showCustomPositionButton.setOnClickListener {
            ...
            HowtankWidget.getInstance().browse(
                this,
                true,
                "Page with custom position",
                "http://c1.howtank.com/custom",
                "10 10 - -"
            )
        }
        ...
        hideButton.setOnClickListener {
            ...
            HowtankWidget.getInstance()
                .browse(this, false, "Page with hidden widget", "http://c1.howtank.com/hidden")
        }
    ...
    private fun appendText(text: String) {
        ...
        if (actionsTextView.layout != null) {
            val scrollAmount =
                actionsTextView.layout.getLineTop(actionsTextView.lineCount) - actionsTextView.height
            if (scrollAmount > 0) {
